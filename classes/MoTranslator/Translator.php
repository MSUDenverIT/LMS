...
/**
 * Use php-gettext original sanitize_plural_expression() & select_string() functions
 * using eval to avoid loading ExpressionLanguage.
 *
 * @link https://bazaar.launchpad.net/~danilo/php-gettext/trunk/view/head:/gettext.php
 */
